...
void __declspec(dllexport) haraka256_256 (uint8_t *out, const uint8_t *in) {
...
void __declspec(dllexport) haraka256_256_chain (uint8_t *out, const uint8_t *in, int chainlen) {
...
void __declspec(dllexport) haraka512_256 (uint8_t *out, const uint8_t *in) {
